...
public class StudentGPA1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter Math Score (0-99): ");
        int math = input.nextInt();
        System.out.println("Enter English Score (0-99): ");
        int english = input.nextInt();
        System.out.println("Enter Physics Score (0-99): ");
        int physics = input.nextInt();
        System.out.println("Enter Chemistry Score (0-99):");
        int chem = input.nextInt();
        System.out.println("Enter P.E. Score (0-99): ");
        int pe = input.nextInt();
        System.out.println("Enter U.S. History Score (0-99): ");
